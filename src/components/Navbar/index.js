      ...
      <NavbarContainer>
        <NavLogo to='/'>
          ...
          <a style={{ display: "flex", alignItems: "center", color: "white", marginBottom: '20px', cursor: 'pointer' }}>
            <DiCssdeck size="3rem" /> <Span>Moin Portfolio</Span>
          </a>
        </NavLogo>
        <MobileIcon>
        ...
        <NavItems>
          ...
          <NavLink to="/skills" href="#">Skills</NavLink>
          <NavLink to="/experience" href="#">Experience</NavLink>
          <NavLink to="/projects" href="#">Projects</NavLink>
          <NavLink to="/education" href="#">Education</NavLink>
        </NavItems>
        <ButtonContainer>
